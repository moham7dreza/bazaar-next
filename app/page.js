      ...
      <div>
          ...
          <main>
              ...
              <section className="container flex justify-center w-1/2 flex-col mx-auto items-center">
                  ...
                  <section
                      className="flex flex-wrap text-center justify-center space-y-14 space-y-reverse mt-10 container">
              ...
              <section className="flex justify-center items-center border-t py-8">
                  <div>
                      <Image src="/images/1.png" width={50} height={50} alt="enamd" className="w-16 h-16"/>
                  </div>
                  <div>
                      <Image src="/images/2.png" width={50} height={50} alt="enamd" className="w-16 h-16"/>
                  </div>
                  <div>
                      <Image src="/images/3.jpeg" width={50} height={50} alt="enamd" className="w-16 h-16"/>
                  </div>
              </section>
          </main>
          <Footer/>
