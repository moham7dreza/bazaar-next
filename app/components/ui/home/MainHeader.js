...
export const MainHeader = () => {
    return (
        <header
            className="flex justify-center items-center border-b-2 pb-4 pt-3 lg:space-x-8 lg:space-x-reverse xl:space-x-12 xl:space-x-reverse">

            {/*<!-- logo -->*/}
            <section className="hidden lg:flex">
                <Image src="/images/logo.png" alt="logo" width={50} height={50} className="w-14 h-14"/>
            </section>
            ...
            {/*<!-- search -->*/}
            <section
                className="container mx-4 lg:mx-0 lg:w-2/6 flex justify-center items-center bg-gray-100 rounded-sm">
